...
namespace FileStorageProject.Migrations
{
    ...
    [Migration("20250601192200_FixChildDirRelation")]
    partial class FixChildDirRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DirectoryEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("FileEntity", b =>
                {
                    ...
                    b.HasIndex("DirectoryId")
                        .HasDatabaseName("ix_files_directory_id");
            ...
            modelBuilder.Entity("TokenInfo", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_token_store");

                    b.ToTable("token_store");
                });
            ...
            modelBuilder.Entity("DirectoryEntity", b =>
                {
                    ...
                    b.HasOne("AppUser", "User")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_directories_asp_net_users_user_id");
            ...
            modelBuilder.Entity("FileEntity", b =>
                {
                    b.HasOne("DirectoryEntity", "Directory")
                        .WithMany("Files")
                        .HasForeignKey("DirectoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_files_directories_directory_id");
                    ...
                    b.HasOne("AppUser", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_files_asp_net_users_user_id");
